...
module.exports = async function (deployer, network, accounts) {
  let energyFiFactoryAddress;
  let wbnbAddress;
  if (network === "testnet") {
    // use existing energyFi contract
    energyFiFactoryAddress = "0x6725F303b657a9451d8BA641348b6761A6CC7a17";
    wbnbAddress = "0xae13d989dac2f0debff460ac112a837c89baa7cd";
  } else if(network === "bsc"){
    energyFiFactoryAddress = "0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73";
    wbnbAddress = "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c";
  }else if(network === "moonbase"){
    energyFiFactoryAddress = "0xF6899c78240F9055F6a896D63Df4dBfbbAa4eace";
    wbnbAddress = "0xA5fd1F6e7980Fd5cA9d062a762030D449990BBBf";
  }else if(network === "moonbeam"){
    energyFiFactoryAddress = "0x7c7EaEa389d958BB37a3fd08706Ca884D53Dc1F3";
    wbnbAddress = "0xAcc15dC74880C9944775448304B263D191c6077F";
  }
  else {
    // deploy energyFi factory
    await deployer.deploy(PancakeFactory, accounts[0]);
    const energyFiFactory = await PancakeFactory.deployed();
    energyFiFactoryAddress = energyFiFactory.address;
  ...
  // deploy energyFi liquidity locker
  await deployer.deploy(PancakeLocker, energyFiFactoryAddress);
  const energyFiLocker = await PancakeLocker.deployed();
  ...
  const addresses = {
    deployer: accounts[0],
    energyFiFactory: energyFiFactoryAddress,
    energyFiLocker: energyFiLocker.address,
    wbnb: wbnbAddress,
